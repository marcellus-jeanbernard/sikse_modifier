...
@section('page')
          ...
          <div class="tbl-row">
            <div class="tbl-cell">
              <!--<h3>Patients Admin Panel</h3>-->
               <h2 style="padding-left:40px;; color:green">Sliders Admin Panel</h2>
              <ol class="breadcrumb breadcrumb-simple">
                <li><a href="{{ url('admin/sliders')}}">View All Sliders</a></li>
      ...
      <div class="box-typical box-typical-padding">
        ...
        <h5 class="m-t-lg with-border">Sliders Inputs</h5>

                  {!!Html::ul($errors->all())!!}         
       <!-- <form  <form method="post" action="patient" enctype="multipart/form-data"> -->
        {!! Form::open(array('url' => 'sliders', 'role'=>'form','files'=> true)) !!}
 ...
 <div class="form-group row">
      ...
      <div class="form-group row">
       ...
       <div class="box-footer">
                    ...
                    {!! Form::submit('Create Slider!', array('class'=>'btn btn-primary')) !!}
                  </div>
                <!--</form> -->
                {!! Form::close() !!}
</div>

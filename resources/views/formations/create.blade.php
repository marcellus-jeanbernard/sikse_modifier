...
@section('page')
          ...
          <div class="tbl-row">
            <div class="tbl-cell">
              <!--<h3>Patients Admin Panel</h3>-->
               <h2 style="padding-left:40px;; color:green">Departments Admin Panel</h2>
              <ol class="breadcrumb breadcrumb-simple">
                <li><a href="{{ url('admin/formations')}}">View All Formations</a></li>
      ...
      <div class="box-typical box-typical-padding">
        ...
        <h5 class="m-t-lg with-border">Departments Inputs</h5>

                  {!!Html::ul($errors->all())!!}         
       <!-- <form  <form method="post" action="patient" enctype="multipart/form-data"> -->
        {!! Form::open(array('url' => 'formations', 'role'=>'form','files'=> true)) !!}
                 
          
          

  <div class="form-group row">
            <label class="col-sm-2 form-control-label">formation</label>
            <div class="col-sm-10">
      ...
      <div class="form-group row">
       ...
       <div class="box-footer">
                    ...
                    {!! Form::submit('Create Formation!', array('class'=>'btn btn-primary')) !!}
                  </div>
                <!--</form> -->
                {!! Form::close() !!}
</div>

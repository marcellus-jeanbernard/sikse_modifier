...
<!--
    ...
    -->
      ...
      <div class="box-typical box-typical-padding">
        ...
        <h5 class="m-t-lg with-border">Projet 7000 pour 1 Inputs</h5>

                  {!!Html::ul($errors->all())!!}         
       <!-- <form  <form method="post" action="patient" enctype="multipart/form-data"> -->
        {!! Form::open(array('url' => 'projetsepts', 'role'=>'form','files'=> true)) !!}
 ...
 {!! Form::select('septpourun_id', $septpouruns) !!}
      ...
      <div class="form-group row">
       ...
       <div class="box-footer">
                    ...
                    {!! Form::submit('Creer Projet 7000 pour 1!', array('class'=>'btn btn-primary')) !!}
                  </div>
                <!--</form> -->
                {!! Form::close() !!}
</div>

                ...
                <div class="right-cont clearfix">
                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">                                                                                              
                            <ul class="navigation">
                                <li class="current dropdown"><a href="index.html">A propos </a>
                                    <ul class="submenu">
                                        <li><a href="index.html">Historique</a></li>
                                        <li><a href="index-2.html">Objectifs</a></li>
...
<!-- 
 ...
 -->
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="submenu">
                                        <li><a href="single-causes.html">Formations</a></li>
                                        <li><a href="single-causes.html">Sondage</a></li>
                                        <li><a href="single-causes.html">Etudes</a></li>
                                        <li><a href="single-causes.html">Exécution de projet</a></li>
                                        <li><a href="single-causes.html">Appui technique</a></li>
    ...
    <aside id="side-navigation">
        ...
        <!--     <div class="logo"><a href="#"><img src="images/logo.png" alt=""></a></div> -->
            ...
            <nav class="navigation">
                <ul>
                    <li class="current dropdown"><a href="index.html">Home mobile essai </a>
                        <ul class="submenu">
                    	...
                    	<div class="row clearfix">
                            ...
                            <!-- <div class="col-md-6 col-sm-6 col-xs-12 column">
                            	<div class="footer-widget about-widget">
                                	<h2>Appropos de <strong>Nous</strong></h2>
...
<!-- 
                            <div class="col-md-6 col-sm-6 col-xs-12 column">
                            	<div class="footer-widget recent-posts">
                                	<h2>Articles <strong>recents</strong></h2>	
                                    <div class="post">
                                    	<h4><a href="#">Aidez-nous a proteger </a></h4>
...
<!--                             <div class="col-md-6 col-sm-6 col-xs-12 column">
    	...
    	<div class="footer-bottom">
            <div class="auto-container">
                <!--Copyright-->
                <div class="copyright">Copyright 2015 by <strong>Sikse - MARCELLUS Jean Bernard</strong> | All rights reserved</div>
            </div>
        </div>
